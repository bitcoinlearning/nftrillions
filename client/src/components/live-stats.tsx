        ...
        <div className="glass-strong rounded-3xl p-8 md:p-12 border border-white/10">
          ...
          <div className="space-y-6">
            ...
            <div className="relative group">
              ...
              <div className="relative glass rounded-2xl p-6 md:p-8 border border-white/10 transition-all-300 group-hover:border-primary/50" data-testid="stat-current-debt">
                <div className="text-muted-foreground text-sm font-medium mb-3 flex items-center gap-2">
