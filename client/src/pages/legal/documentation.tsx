        ...
        <div className="glass-strong rounded-3xl p-8 md:p-12 border border-white/20">
          ...
          <div className="prose prose-invert max-w-none space-y-6">
            ...
            <section>
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div className="glass rounded-lg p-3">
                  ...
                  <div className="text-muted-foreground">Slices 1-100 • $100 value</div>
                </div>
                <div className="glass rounded-lg p-3">
                  <div className="font-medium">Tier 2</div>
                  <div className="text-muted-foreground">Slices 101-200 • $200 value</div>
                </div>
                <div className="glass rounded-lg p-3">
                  <div className="font-medium">Tier 3</div>
                  <div className="text-muted-foreground">Slices 201-300 • $300 value</div>
                </div>
                <div className="glass rounded-lg p-3">
                  <div className="font-medium">Tier 4</div>
                  <div className="text-muted-foreground">Slices 301-400 • $400 value</div>
                </div>
                <div className="glass rounded-lg p-3">
                  <div className="font-medium">Tier 5</div>
                  <div className="text-muted-foreground">Slices 401-500 • $500 value</div>
                </div>
                <div className="glass rounded-lg p-3">
                  <div className="font-medium">Tier 6</div>
                  <div className="text-muted-foreground">Slices 501-600 • $600 value</div>
                </div>
                <div className="glass rounded-lg p-3">
                  <div className="font-medium">Tier 7</div>
                  <div className="text-muted-foreground">Slices 601-700 • $700 value</div>
                </div>
                <div className="glass rounded-lg p-3">
                  <div className="font-medium">Tier 8</div>
                  <div className="text-muted-foreground">Slices 701-800 • $800 value</div>
                </div>
                <div className="glass rounded-lg p-3">
                  <div className="font-medium">Tier 9</div>
                  <div className="text-muted-foreground">Slices 801-900 • $900 value</div>
                </div>
                <div className="glass rounded-lg p-3">
                  <div className="font-medium">Tier 10</div>
                  <div className="text-muted-foreground">Slices 901-1000 • $1000 value</div>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 text-muted-foreground">
                <li><strong>Slices 1-389:</strong> Already released (historical debt has reached $38.9T)</li>
                <li><strong>Slices 390-1000:</strong> Auto-release as debt crosses each $100B milestone</li>
                <li><strong>Current Debt:</strong> ~$37.8T (live from Treasury APIs)</li>
                <li><strong>Next Release:</strong> Slice #390 when debt reaches $39.0T</li>
              </ul>
            </section>
